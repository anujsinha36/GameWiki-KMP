...
android {
    namespace = "org.example.d9kmptemplate"
    compileSdk = libs.versions.android.compileSdk.get().toInt()

    defaultConfig {
        applicationId = "org.example.d9kmptemplate"
...
compose.desktop {
    application {
        mainClass = "org.example.d9kmptemplate.MainKt"

        nativeDistributions {
            targetFormats(TargetFormat.Dmg, TargetFormat.Msi, TargetFormat.Deb)
            packageName = "org.example.d9kmptemplate"
